...
#warning "IMSI 310.028.90832150"
   ...
   */
     data->imsi.length = 8;
     data->imsi.u.num.parity = 0x1;  // Type of identity = IMSI, odd
     data->imsi.u.num.digit1 = 4;  // MCC digit 1
     data->imsi.u.num.digit2 = 6;  // MCC digit 2
     data->imsi.u.num.digit3 = 0;  // MCC digit 3
     data->imsi.u.num.digit4 = 9;  // MNC digit 1
     data->imsi.u.num.digit5 = 9;  // MNC digit 2
     data->imsi.u.num.digit6 = 7;//0xF;  // MNC digit 3
     data->imsi.u.num.digit7 = 9;
     data->imsi.u.num.digit8 = 0;
     ...
     data->imsi.u.num.digit13 = 0;
     data->imsi.u.num.digit14 = 8;
     data->imsi.u.num.digit15 = 8;

     data->rplmn.MCCdigit1 = 4;
     data->rplmn.MCCdigit2 = 6;
     data->rplmn.MCCdigit3 = 0;
     data->rplmn.MNCdigit1 = 9;
     data->rplmn.MNCdigit2 = 9;
