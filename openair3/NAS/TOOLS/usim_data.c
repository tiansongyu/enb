...
#warning "IMSI 208.10.00001234"
     ...
     */
    #warning "IMSI '460.99.7900000088'"
    usim_data.imsi.length = 8;
    usim_data.imsi.u.num.parity = ODD_PARITY;      // Parity: even
    usim_data.imsi.u.num.digit1 = 4;                // MCC digit 1
    usim_data.imsi.u.num.digit2 = 6;                // MCC digit 2
    usim_data.imsi.u.num.digit3 = 0;                // MCC digit 3
    usim_data.imsi.u.num.digit4 = 9;                // MNC digit 1
    usim_data.imsi.u.num.digit5 = 9;                // MNC digit 2
    usim_data.imsi.u.num.digit6 = 7;
    usim_data.imsi.u.num.digit7 = 9;
    usim_data.imsi.u.num.digit8 = 0;
    ...
    usim_data.imsi.u.num.digit13 = 0;
    usim_data.imsi.u.num.digit14 = 8;
    usim_data.imsi.u.num.digit15 = 8;
#endif
