...
//------------------------------------------------------------------------------
{
  ...
  //S1AP_DEBUG("ue_initial_id=%d  eNB_ue_s1ap_id:%d(%x) \n",
  //    s1ap_nas_first_req_p->ue_initial_id,
  ...
  if (s1ap_nas_first_req_p->ue_identity.presenceMask & UE_IDENTITIES_s_tmsi) 
  {
    ...
    S1AP_DEBUG("S_TMSI_PRESENT=%0x\n",
        s1ap_nas_first_req_p->ue_identity.s_tmsi.m_tmsi);
...
//------------------------------------------------------------------------------
{
  ...
  //xhd_oai_multuser
  //printf("s1ap_eNB_handle_nas_downlink: mme_ue_s1ap_id=%d/%d ue_initial_id=%d\n", 
...
//------------------------------------------------------------------------------
{
  ...
  //xhd_oai_multuser
  //printf("s1ap_eNB_nas_uplink:eNB_ue_s1ap_id=%d/0x%x %d/0x%x mme_ue_s1ap_id=%d eNB_ue_s1ap_id=%d\n", 
