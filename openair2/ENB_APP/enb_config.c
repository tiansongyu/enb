...
static void enb_config_display1(void)
{
  int i,j;
...
static void enb_config_display2(void)
{
  int i,j;
...
const Enb_properties_array_t *enb_config_init1(char* lib_config_file_name_pP)
{
  config_t          cfg;
  config_setting_t *setting                       = NULL;
  config_setting_t *subsetting                    = NULL;
...
# if defined(ENABLE_USE_MME)
  ...
  enb_properties.number = enb_properties_index;
...
const Enb_properties_array_t *enb_config_init2(char* lib_config_file_name_pP)
{
  config_t          cfg;
  config_setting_t *setting                       = NULL;
  config_setting_t *subsetting                    = NULL;
