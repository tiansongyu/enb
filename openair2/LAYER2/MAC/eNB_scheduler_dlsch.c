...
//------------------------------------------------------------------------------
{
  ...
  UE_info_t            *UE_info  = &eNB->UE_info[UE_idP];
  unsigned char         DAI;
  UE_TEMPLATE *UE_template=&UE_info->UE_template[CC_idP];

  if (frame_parms[CC_idP]->frame_type == TDD) {
    DAI = (UE_template->DAI-1)&3;
    ...
    case 1:
      switch (subframeP) {
      case 1:
        UE_template->DAI_ul[7] = DAI;
        break;

      case 4:
        UE_template->DAI_ul[8] = DAI;
        break;

      case 6:
        UE_template->DAI_ul[2] = DAI;
        break;

      case 9:
        UE_template->DAI_ul[3] = DAI;
        break;
      }
...
//xhd_oai_50
int ue_schedule_none_1 = 0;
int ue_schedule_none_2 = 0;
int ue_schedule_none_3 = 0;
int ue_schedule_none_4 = 0;
int ue_schedule_none_5 = 0;
int ue_schedule_none_6 = 0;

#define MAX_HARQ 10
#define MAX_ROUND 8
typedef struct  
{
unsigned int dl_send_bit;
unsigned int dl_send_times;
unsigned int dl_recv_ack;
unsigned int dl_recv_nack;
unsigned int ul_decode_succ;
unsigned int ul_decode_count; //only for succ case
unsigned int ul_decode_fail;
unsigned int ul_send_ack;
unsigned int ul_send_nack;
}harq_stats;
harq_stats gulHarq[MAX_HARQ][MAX_ROUND];



//xhd_oai_multuser
#define OLTE_MAX_USER NUMBER_OF_UE_MAX
extern int sche_debug[OLTE_MAX_USER][30];

extern uint8_t get_phy_ue_id_by_rnti(uint16_t rnti);

void dci_set_dlsch_round0(void *DLSCH_dci, uint8_t trans_mode, uint8_t frame_type, 
    uint8_t N_RB_DL, uint8_t mcs, uint8_t harq_pid, uint8_t ndi, 
    uint8_t tpc, uint8_t dai, uint8_t *dl_pow_off)
{
    switch (trans_mode) 
    {
          case 1:
          ...
          default:
            if (frame_type == TDD) {
              ...
              case 6:
                ...
                ((DCI1_1_5MHz_FDD_t*)DLSCH_dci)->ndi = ndi;
              ...
              case 25:
                ...
                ((DCI1_5MHz_FDD_t*)DLSCH_dci)->ndi = ndi;
              ...
              case 50:
                ...
                ((DCI1_10MHz_FDD_t*)DLSCH_dci)->ndi = ndi;
              ...
              case 100:
                ...
                ((DCI1_20MHz_FDD_t*)DLSCH_dci)->ndi = ndi;
          ...
          case 3:
            if (frame_type == TDD) {
              ...
              case 6:
                ...
                ((DCI2A_1_5MHz_2A_TDD_t*)DLSCH_dci)->ndi1 = ndi;
                ...
                ((DCI2A_1_5MHz_2A_TDD_t*)DLSCH_dci)->dai      = dai;
              ...
              case 25:
                ...
                ((DCI2A_5MHz_2A_TDD_t*)DLSCH_dci)->ndi1 = ndi;
                ((DCI2A_5MHz_2A_TDD_t*)DLSCH_dci)->rv1 = 0;
                ((DCI2A_5MHz_2A_TDD_t*)DLSCH_dci)->dai      = dai;
              ...
              case 50:
                ...
                ((DCI2A_10MHz_2A_TDD_t*)DLSCH_dci)->ndi1 = ndi;
                ((DCI2A_10MHz_2A_TDD_t*)DLSCH_dci)->rv1 = 0;
                ((DCI2A_10MHz_2A_TDD_t*)DLSCH_dci)->dai      = dai;
              ...
              case 100:
                ...
                ((DCI2A_20MHz_2A_TDD_t*)DLSCH_dci)->ndi1 = ndi;
                ((DCI2A_20MHz_2A_TDD_t*)DLSCH_dci)->rv1 = 0;
                ((DCI2A_20MHz_2A_TDD_t*)DLSCH_dci)->dai      = dai;
              ...
              case 6:
                ...
                ((DCI2A_1_5MHz_2A_FDD_t*)DLSCH_dci)->ndi1 = ndi;
              ...
              case 25:
                ...
                ((DCI2A_5MHz_2A_FDD_t*)DLSCH_dci)->ndi1 = ndi;
              ...
              case 50:
                ...
                ((DCI2A_10MHz_2A_FDD_t*)DLSCH_dci)->ndi1 = ndi;
              ...
              case 100:
                ...
                ((DCI2A_20MHz_2A_FDD_t*)DLSCH_dci)->ndi1 = ndi;
          ...
          case 4:
            ...
            ((DCI2_5MHz_2A_TDD_t*)DLSCH_dci)->dai = dai;
          ...
          case 5:
            ...
            ((DCI1E_5MHz_2A_M10PRB_TDD_t*)DLSCH_dci)->rv = 0;
            ((DCI1E_5MHz_2A_M10PRB_TDD_t*)DLSCH_dci)->dai = dai;
            ...
            ((DCI1E_5MHz_2A_M10PRB_TDD_t*)DLSCH_dci)->dl_power_off = *dl_pow_off;
...
void dci_set_dlsch_round1(void *DLSCH_dci, uint8_t trans_mode, uint8_t frame_type, 
  uint8_t N_RB_DL, uint8_t harq_pid, uint8_t ucNdi, 
  uint8_t rv, uint8_t dai, uint8_t *dl_pow_off)
{
      ...
      switch (trans_mode) 
      {
          ...
          default:
            ...
            case 6:
              if (frame_type == TDD) {
                ((DCI1_1_5MHz_TDD_t*)DLSCH_dci)->ndi      = ucNdi;
                ((DCI1_1_5MHz_TDD_t*)DLSCH_dci)->harq_pid = harq_pid;
                ((DCI1_1_5MHz_TDD_t*)DLSCH_dci)->rv       = rv;
                ((DCI1_1_5MHz_TDD_t*)DLSCH_dci)->dai      = dai;
              } else {
                ((DCI1_1_5MHz_FDD_t*)DLSCH_dci)->ndi      = ucNdi;
                ((DCI1_1_5MHz_FDD_t*)DLSCH_dci)->harq_pid = harq_pid;
                ((DCI1_1_5MHz_FDD_t*)DLSCH_dci)->rv       = rv;
            ...
            case 25:
              if (frame_type == TDD) {
                ((DCI1_5MHz_TDD_t*)DLSCH_dci)->ndi      = ucNdi;
                ((DCI1_5MHz_TDD_t*)DLSCH_dci)->harq_pid = harq_pid;
                ((DCI1_5MHz_TDD_t*)DLSCH_dci)->rv       = rv;
                ((DCI1_5MHz_TDD_t*)DLSCH_dci)->dai      = dai;
              } else {
                ((DCI1_5MHz_FDD_t*)DLSCH_dci)->ndi      = ucNdi;
                ((DCI1_5MHz_FDD_t*)DLSCH_dci)->harq_pid = harq_pid;
                ((DCI1_5MHz_FDD_t*)DLSCH_dci)->rv       = rv;
            ...
            case 50:
              if (frame_type == TDD) {
                ((DCI1_10MHz_TDD_t*)DLSCH_dci)->ndi      = ucNdi;
                ((DCI1_10MHz_TDD_t*)DLSCH_dci)->harq_pid = harq_pid;
                ((DCI1_10MHz_TDD_t*)DLSCH_dci)->rv       = rv;
                ((DCI1_10MHz_TDD_t*)DLSCH_dci)->dai      = dai;
              } else {
                ((DCI1_10MHz_FDD_t*)DLSCH_dci)->ndi      = ucNdi;
                ((DCI1_10MHz_FDD_t*)DLSCH_dci)->harq_pid = harq_pid;
                ((DCI1_10MHz_FDD_t*)DLSCH_dci)->rv       = rv;
            ...
            case 100:
              if (frame_type == TDD) {
                ((DCI1_20MHz_TDD_t*)DLSCH_dci)->ndi      = ucNdi;
                ((DCI1_20MHz_TDD_t*)DLSCH_dci)->harq_pid = harq_pid;
                ((DCI1_20MHz_TDD_t*)DLSCH_dci)->rv       = rv;
                ((DCI1_20MHz_TDD_t*)DLSCH_dci)->dai      = dai;
              } else {
                ((DCI1_20MHz_FDD_t*)DLSCH_dci)->ndi      = ucNdi;
                ((DCI1_20MHz_FDD_t*)DLSCH_dci)->harq_pid = harq_pid;
                ((DCI1_20MHz_FDD_t*)DLSCH_dci)->rv       = rv;
          ...
          case 5:
            ...
            ((DCI1E_5MHz_2A_M10PRB_TDD_t*)DLSCH_dci)->harq_pid = harq_pid;
            ((DCI1E_5MHz_2A_M10PRB_TDD_t*)DLSCH_dci)->rv = rv;
            ((DCI1E_5MHz_2A_M10PRB_TDD_t*)DLSCH_dci)->dai = dai;
...
extern int ta_adjust_posi_sum[NUMBER_OF_UE_MAX];
extern int ta_adjust_posi_num[NUMBER_OF_UE_MAX];
extern int ta_adjust_nposi_sum[NUMBER_OF_UE_MAX];
extern int ta_adjust_nposi_num[NUMBER_OF_UE_MAX];
extern int ta_adjust_zero_num[NUMBER_OF_UE_MAX];

//------------------------------------------------------------------------------
void
schedule_ue_spec_si_ri(
  module_id_t   module_idP,
  frame_t       frameP,
  sub_frame_t   subframeP,
  ...
  int*           mbsfn_flag,
  unsigned char vrb_map[MAX_NUM_CCs][N_RBG_MAX]
)
//------------------------------------------------------------------------------
{
  ...
  uint16_t              nb_rb,total_nb_available_rb[MAX_NUM_CCs],nb_available_rb;
  int16_t               nb_rb_temp;
  ...
  aggregation = 0; //1; // set to the maximum aggregation level
  ...
  dlsch_scheduler_pre_processor_si_ri(module_idP,
                                frameP,
                                subframeP,
                                N_RBG,
                                mbsfn_flag,
  ...
  for (CC_id=0; CC_id<MAX_NUM_CCs; CC_id++) {
    ...
    for (UE_id=UE_list->head; UE_id>=0; UE_id=UE_list->next[UE_id]) 
    {
      ...
      uint8_t ucUeId = UE_id; //get_phy_ueid_by_rnti(rnti);

      if(ucUeId < OLTE_MAX_USER) sche_debug[ucUeId][0]++;

      eNB_UE_stats = mac_xface->get_eNB_UE_stats(module_idP,CC_id,rnti);
      ue_sched_ctl = &UE_list->UE_sched_ctrl[UE_id];
      UE_TEMPLATE *UE_template = &UE_info->UE_template[CC_id];

      if (frame_parms[CC_id]->frame_type == TDD && subframeP == 5)  
      {
            continue_flag=1;
            if(ucUeId < OLTE_MAX_USER) sche_debug[ucUeId][5]++;
      }
      //else if ((frame_parms[CC_id]->frame_type == FDD) && ((subframeP == 5)/*||(subframeP == 0)*/))
      //{
      //      continue_flag=1;
      //      if(ucUeId < OLTE_MAX_USER) sche_debug[ucUeId][5]++;
      //}
      else if (rnti==NOT_A_RNTI) {
        //LOG_D(MAC,"Cannot find rnti for UE_id %d (num_UEs %d)\n",UE_id,UE_info->num_UEs);
        // mac_xface->macphy_exit("Cannot find rnti for UE_id");
        continue_flag=1;
        ue_schedule_none_1++;
        if(ucUeId < OLTE_MAX_USER) sche_debug[ucUeId][1]++;
      }
      else if (eNB_UE_stats==NULL) {
      ...
      else if ((ue_sched_ctl->pre_nb_available_rbs[CC_id] == 0) ) 
      {
        LOG_D(MAC,"[eNB %d] Frame %d : no RB allocated for UE %d on CC_id %d: continue \n",
              module_idP, frameP, UE_id, CC_id, nb_rb_used0[CC_id], 
              ue_sched_ctl->pre_nb_available_rbs[CC_id], nCCE[CC_id], aggregation);
        //if(mac_xface->get_transmission_mode(module_idP,rnti)==5)
        continue_flag=1; //to next user (there might be rbs availiable for other UEs in TM5
        ue_schedule_none_3++;
        // else
        //  break;
        if(ucUeId < OLTE_MAX_USER) sche_debug[ucUeId][3]++;
      }
      else if (  (nCCE[CC_id] < (1<<aggregation))) {
        LOG_D(MAC,"[eNB %d] Frame %d : no RB allocated for UE %d on CC_id %d: continue \n",
              module_idP, frameP, UE_id, CC_id, nb_rb_used0[CC_id], 
              ue_sched_ctl->pre_nb_available_rbs[CC_id], nCCE[CC_id], aggregation);
        //if(mac_xface->get_transmission_mode(module_idP,rnti)==5)
        ...
        // else
        //  break;
        if(ucUeId < OLTE_MAX_USER) sche_debug[ucUeId][4]++;
      }
      ...
      UE_info->eNB_UE_stats[CC_id].crnti= rnti;
      UE_info->eNB_UE_stats[CC_id].rrc_status=mac_eNB_get_rrc_status(module_idP,rnti);
      UE_info->eNB_UE_stats[CC_id].harq_pid = harq_pid; 
      UE_info->eNB_UE_stats[CC_id].harq_round = round;
      ...
      */
      ...
      if( eNB_UE_stats->DL_cqi[0] > MAX_CQI_VALUE )
      {
        printf("schedule_ue_spec: FATAL error! DL_cqi %d overflow!\n",eNB_UE_stats->DL_cqi[0]);
        eNB_UE_stats->DL_cqi[0] = MAX_CQI_VALUE;
      }
      ...
      // store stats
      UE_info->eNB_UE_stats[CC_id].dl_cqi= eNB_UE_stats->DL_cqi[0];
      ...
      LOG_D(MAC,"[eNB %d] Frame %d: Scheduling UE %d on CC_id %d (rnti %x, harq_pid %d, round %d, rb %d, cqi %d, mcs %d, ncc %d, rrc %d)\n",
            ...
            nCCE[CC_id],
            UE_info->eNB_UE_stats[CC_id].rrc_status);


      // Note this code is for a specific DCI format
      DLSCH_dci = (void *)UE_template->DLSCH_DCI[harq_pid];
      ...
      if (round > 0) 
      {
        uint8_t ucNdi = UE_template->oldNDI[harq_pid];
        
          if(ucUeId < OLTE_MAX_USER) sche_debug[ucUeId][6]++;
        ...
        if (frame_parms[CC_id]->frame_type == TDD) {
          ...
          if(frame_parms[CC_id]->N_RB_DL==25)
          {
              update_ul_dci(module_idP,CC_id,rnti,UE_template->DAI,subframeP);
          }
          else if(frame_parms[CC_id]->N_RB_DL==50)
          {
              update_ul_dci50(module_idP,CC_id,rnti,UE_template->DAI,subframeP);
          }
          else if(frame_parms[CC_id]->N_RB_DL==100)
          {
              update_ul_dci100(module_idP,CC_id,rnti,UE_template->DAI,subframeP);
          }
          LOG_D(MAC,"DAI update: CC_id %d subframeP %d: UE %d, DAI %d\n",
                CC_id,subframeP,UE_id,UE_template->DAI);
        }
        ...
        if (nb_rb <= nb_available_rb) {
          ...
          if(nb_rb == ue_sched_ctl->pre_nb_available_rbs[CC_id]) 
          {
            ...
            { 
              ...
              UE_template->rballoc_subband[harq_pid][j] 
          ...
          for(j=0; j<frame_parms[CC_id]->N_RBG; j++) {
            PHY_vars_eNB_g[module_idP][CC_id]->mu_mimo_mode[UE_id].rballoc_sub[j] = UE_template->rballoc_subband[harq_pid][j];
          }

         
          dci_set_dlsch_round1((void *)DLSCH_dci, mac_xface->get_transmission_mode(module_idP,CC_id,rnti),frame_parms[CC_id]->frame_type,
            frame_parms[CC_id]->N_RB_DL, 
            harq_pid, ucNdi, round&3, (UE_template->DAI-1)&3, &ue_sched_ctl->dl_pow_off[CC_id] );
          ...
          UE_info->eNB_UE_stats[CC_id].num_retransmission+=1;
          UE_info->eNB_UE_stats[CC_id].rbs_used_retx=nb_rb;
          UE_info->eNB_UE_stats[CC_id].total_rbs_used_retx+=nb_rb;
          UE_info->eNB_UE_stats[CC_id].ncce_used_retx=nCCE[CC_id];
          UE_info->eNB_UE_stats[CC_id].dlsch_mcs1=eNB_UE_stats->dlsch_mcs1;
          UE_info->eNB_UE_stats[CC_id].dlsch_mcs2=eNB_UE_stats->dlsch_mcs1;
        }
        else 
        {
            if(ucUeId < OLTE_MAX_USER) sche_debug[ucUeId][27]++;

            static int aa = 0;
            if( aa++ %100 == 0)
            {
              LOG_I(MAC,"[eNB %d] Frame %d subframeP %d : don't schedule UE %d at harq_pid%d nb_rb=%d < nb_available_rb=%d\n",
                    module_idP, frameP, subframeP, UE_id, harq_pid, nb_rb, nb_available_rb);

              #if 0
              for (int jj =UE_list->head; jj>=0; jj=UE_list->next[jj]) 
              {
                  printf(" [ %d %d %d %d %d-%d %d-%d]",
                        jj,
                        UE_list->UE_sched_ctrl[jj].round[CC_id][subframeP],
                        UE_list->UE_template[CC_id][jj].nb_rb[harq_pid],
                        UE_list->UE_sched_ctrl[jj].pre_nb_available_rbs[CC_id][subframeP],
                        UE_list->UE_sched_ctrl[jj].remain_1[CC_id][subframeP],
                        UE_list->UE_sched_ctrl[jj].nb_rbs_required[CC_id][subframeP],
                        UE_list->UE_sched_ctrl[jj].remain_1b[CC_id][subframeP],
                        UE_list->UE_sched_ctrl[jj].nb_rbs_requiredb[CC_id][subframeP]);
      ...
      { 
        if(ucUeId < OLTE_MAX_USER) sche_debug[ucUeId][7]++;
        ...
        //#ifndef EXMIMO_IOT
        if( eNB_UE_stats->timing_advance_active )
        {
            ta_update = eNB_UE_stats->timing_advance_update/update_TA;
            if( ta_update == 0)
            {
                ta_update = 255;
              ta_adjust_zero_num[UE_id]++;
            }
            else if( ta_update > 0)
            {
              ta_adjust_posi_sum[UE_id]+=ta_update;
              ta_adjust_posi_num[UE_id]++;
            }
            else
            {
                ta_adjust_nposi_sum[UE_id]+=ta_update;
                ta_adjust_nposi_num[UE_id]++;
            }
            eNB_UE_stats->timing_advance_active = 0;
        }
        else
        {
            ta_update = 255;
        ...
        //ta_len = ((eNB_UE_stats->timing_advance_active)!=0) ? 2 : 0;
        ta_len = ((ta_update)!=255) ? 2 : 0;
        ...
        if ( TBS-ta_len-header_len_dcch > 0 ) 
        {
          ...
          if (rlc_status.bytes_in_buffer > 0) {  // There is DCCH to transmit
            ...
            sdu_lcids[0] = DCCH;
            UE_info->eNB_UE_stats[CC_id].num_pdu_tx[DCCH]+=1;
            UE_info->eNB_UE_stats[CC_id].num_bytes_tx[DCCH]+=sdu_lengths[0];
            num_sdus = 1;
        ...
        if (TBS-ta_len-header_len_dcch-sdu_length_total > 0 ) 
        {
          ...
          if (rlc_status.bytes_in_buffer > 0) {
            ...
            header_len_dcch += 2;
            UE_info->eNB_UE_stats[CC_id].num_pdu_tx[DCCH1]+=1;
            UE_info->eNB_UE_stats[CC_id].num_bytes_tx[DCCH1]+=sdu_lengths[num_sdus];
            num_sdus++;
        ...
        {
            if(ucUeId < OLTE_MAX_USER) sche_debug[ucUeId][8]++;
          ...
          if (rlc_status.bytes_in_buffer > 0) 
          {
              if(ucUeId < OLTE_MAX_USER) sche_debug[ucUeId][9]++;
            ...
            sdu_length_total += sdu_lengths[num_sdus];
            UE_info->eNB_UE_stats[CC_id].num_pdu_tx[DTCH]+=1;
            UE_info->eNB_UE_stats[CC_id].num_bytes_tx[DTCH]+=sdu_lengths[num_sdus];
        ...
        {
            if(ucUeId < OLTE_MAX_USER) sche_debug[ucUeId][10]++;
          ...
          if(nb_rb == ue_sched_ctl->pre_nb_available_rbs[CC_id]) 
          {
            ...
            { 
                // for indicating the rballoc for each sub-band
                UE_template->rballoc_subband[harq_pid][j] = ue_sched_ctl->rballoc_sub_UE[CC_id][j];
            }
            
            /*if( subframeP == 0 || subframeP==5)
            {
              printf("1:nb_rb=%d rballoc_subband=", 
                  nb_rb);
              for(j=0;j<17;j++)
              {
                  printf("%d ",UE_template->rballoc_subband[harq_pid][j]);
              }
              printf("\n");
            }*/
          } 
          else 
          {
            ...
            while((nb_rb_temp > 0) && (j<frame_parms[CC_id]->N_RBG)) 
            {
              if(ue_sched_ctl->rballoc_sub_UE[CC_id][j] == 1) 
              {
                UE_template->rballoc_subband[harq_pid][j] = 1; //ue_sched_ctl->rballoc_sub_UE[CC_id][j];
            ...
            /*if( subframeP == 0 || subframeP==5)
            {
              printf("2:nb_rb=%d-%d rballoc_subband=", 
                  ue_sched_ctl->pre_nb_available_rbs[CC_id], nb_rb);
              for(j=0;j<17;j++)
              {
                  printf("%d ",UE_template->rballoc_subband[harq_pid][j]);
              }
          ...
          offset = generate_dlsch_header((unsigned char*)UE_info->DLSCH_pdu[CC_id][subframeP&1].payload[0],
          ...
          {
              LOG_D(MAC,
                    "[eNB %d][DLSCH] Frame %d DO NOT Generate header for UE_id %d on CC_id %d: sdu_length_total %d, num_sdus %d, sdu_lengths[0] %d, sdu_lcids[0] %d => payload offset %d,timing advance value : %d, padding %d,post_padding %d,(mcs %d, TBS %d, nb_rb %d),header_dcch %d, header_dtch %d\n",
                    module_idP,frameP, UE_id, CC_id, sdu_length_total,num_sdus,sdu_lengths[0],sdu_lcids[0],offset,
                    ta_update,padding,post_padding,mcs,TBS,nb_rb,header_len_dcch,header_len_dtch);
          }
          ...
          memcpy(&UE_info->DLSCH_pdu[CC_id][subframeP&1].payload[0][offset],dlsch_buffer,sdu_length_total);
          // memcpy(&eNB_mac_inst[0].DLSCH_pdu[0][0].payload[0][offset],dcch_buffer,sdu_lengths[0]);

          // fill remainder of DLSCH with random data
          for (j=0; j<(TBS-sdu_length_total-offset); j++) {
            UE_info->DLSCH_pdu[CC_id][subframeP&1].payload[0][offset+sdu_length_total+j] = (char)(taus()&0xff);
          }

          //eNB_mac_inst[0].DLSCH_pdu[0][0].payload[0][offset+sdu_lengths[0]+j] = (char)(taus()&0xff);
          if (opt_enabled == 1) {
            trace_pdu(1, (uint8_t *)UE_info->DLSCH_pdu[CC_id][subframeP&1].payload[0],
          ...
          if(ucUeId < OLTE_MAX_USER) sche_debug[ucUeId][11]++;
          ...
          UE_info->eNB_UE_stats[CC_id].rbs_used = nb_rb;
          UE_info->eNB_UE_stats[CC_id].total_rbs_used += nb_rb;
          UE_info->eNB_UE_stats[CC_id].ncce_used = nCCE[CC_id];
          UE_info->eNB_UE_stats[CC_id].dlsch_mcs1=eNB_UE_stats->dlsch_mcs1;
          UE_info->eNB_UE_stats[CC_id].dlsch_mcs2=mcs;
          UE_info->eNB_UE_stats[CC_id].TBS = TBS;

          UE_info->eNB_UE_stats[CC_id].overhead_bytes= TBS- sdu_length_total;
          UE_info->eNB_UE_stats[CC_id].total_sdu_bytes+= sdu_length_total;

          //xhd_oai_test
          if( UE_info->eNB_UE_stats[CC_id].sdu_bytes_per_frame > (sdu_length_total))
          {
              UE_info->eNB_UE_stats[CC_id].sdu_bytes_per_frame -= (sdu_length_total);
          }
          else
          {
              UE_info->eNB_UE_stats[CC_id].sdu_bytes_per_frame = 0;
          }
          UE_info->eNB_UE_stats[CC_id].total_pdu_bytes+= TBS;
          UE_info->eNB_UE_stats[CC_id].total_num_pdus+=1;
...
#warning only for 5MHz channel
	  ...
	  int32_t framex10psubframe = UE_template->pucch_tpc_tx_frame*10+UE_template->pucch_tpc_tx_subframe;
		...
		tpc = 1; //0
          ...
          if(tpc != 1 && (frameP&0xff) == 0)
          {
    	      LOG_I(MAC,"[eNB %d] DLSCH scheduler:format 1(for PUCCH) frame %d, subframe %d, harq_pid %d, tpc %d, accumulated %d, normalized/target rx power %d/%d\n",
    		    module_idP,frameP, subframeP,harq_pid,tpc,
    		    tpc_accumulated,normalized_rx_power,target_rx_power);
    	      print_info("[eNB %d] DLSCH scheduler:format 1(for PUCCH) frame %d, subframe %d, harq_pid %d, tpc %d, accumulated %d, normalized/target rx power %d/%d\n",
    		    module_idP,frameP, subframeP,harq_pid,tpc,
    		    tpc_accumulated,normalized_rx_power,target_rx_power);
          }
	    ...
	    tpc = 1; //0
          ...
          dci_set_dlsch_round0(DLSCH_dci, mac_xface->get_transmission_mode(module_idP,CC_id,rnti),
                     frame_parms[CC_id]->frame_type,frame_parms[CC_id]->N_RB_DL,
                    mcs, harq_pid, 1-UE_template->oldNDI[harq_pid], tpc, (UE_template->DAI-1)&3,
...
//xhd_oai_50
int dci_schedule_count = 0;
int dci_alloc_count = 0;
int dci_alloc_nb_rb_sum = 0;
...
//------------------------------------------------------------------------------
{
  ...
  if( PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.N_RB_DL == 25 )
  {
      first_rb = 6;
  }
  else if( PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.N_RB_DL == 50 )
  {
      first_rb = 19;
  }
  else if( PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.N_RB_DL == 100 )
  {
      first_rb = 44;
  }
  else
  ...
  for (CC_id=0; CC_id<MAX_NUM_CCs; CC_id++) {
    ...
    // SI DLSCH
    //  printf("BCCH check\n");
    if (eNB->common_channels[CC_id].bcch_active == 1 && subframeP == 5) {
      ...
      */
      ...
      if (PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.frame_type == TDD) {
        ...
        case 50:
          ...
          //rballoc[CC_id] |= get_rballoc50(0,((DCI1A_10MHz_TDD_1_6_t*)BCCH_alloc_pdu)->rballoc);
          add_common_dci(DCI_pdu,
                         BCCH_alloc_pdu,
                         SI_RNTI,
      ...
      else 
      {
        ...
        case 50:
          ...
          //rballoc[CC_id] |= get_rballoc50(0,((DCI1A_10MHz_FDD_t*)BCCH_alloc_pdu)->rballoc);
          add_common_dci(DCI_pdu,
                         BCCH_alloc_pdu,
                         SI_RNTI,
    ...
    if (RA_scheduledP == 1) {
      for (i=0; i<NB_RA_PROC_MAX; i++) {
        ...
        if (RA_template->generate_Msg4_dci == 1) 
        {
          ...
          if (PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.frame_type == TDD) {
            ...
            case 25:
              ...
              ((DCI1A_5MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->ndi=0;
        ...
        else if (RA_template->wait_ack_Msg4==1) 
        {
          ...
          LOG_D(MAC,"[eNB %d][RAPROC] CC_id %d Frame %d, subframeP %d: Checking if Msg4 was acknowledged: \n",
                module_idP,CC_id,frameP,subframeP);
          ...
          if (round>0) 
          {
            ...
            if (PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.frame_type == TDD) 
            {
                if(PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.N_RB_DL == 50)
                {
            ...
            if (PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.frame_type == TDD) 
            {
                ...
                {
                  ((DCI1A_10MHz_TDD_1_6_t*)&RA_template->RA_alloc_pdu2[0])->rballoc 
                    = mac_xface->computeRIV(PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.N_RB_UL,first_rb,4);
                  rballoc[CC_id] |= mac_xface->get_rballoc(((DCI1A_10MHz_TDD_1_6_t*)&RA_template->RA_alloc_pdu2[0])->vrb_type,
                                    ((DCI1A_10MHz_TDD_1_6_t*)&RA_template->RA_alloc_pdu2[0])->rballoc);
                }
                else if(PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.N_RB_DL == 100)
          ...
          else 
          {
            ...
            phy_clear_rb(RA_template->rnti);

            //xhd_oai_multuser
            //DevAssert( UE_id != -1 );
            if(UE_id != -1)
            {
                eNB_mac_inst[module_idP].UE_info[UE_id].UE_template[UE_PCCID(module_idP,UE_id)].configured=TRUE;
            }
            else
            {
                LOG_W(MAC,"[eNB %d][RAPROC] fill_DLSCH_dci CC_id %d Frame %d, subframeP %d : Rnti=%x not found!\n",
                    module_idP,CC_id,frameP,subframeP,RA_template->rnti);
                return;
            }
    ...
    for (UE_id=UE_list->head; UE_id>=0; UE_id=UE_list->next[UE_id]) 
    {
      ...
      if (eNB_dlsch_info[module_idP][CC_id][UE_id].status == S_DL_SCHEDULED) {
        ...
        //xhd_oai_rb 
        //UE_sched_ctrl中的harq_pid有可能是上行的，所以最好重新获取一下
        ...
        nb_rb = UE_info->UE_template[CC_id].nb_rb[harq_pid];

        DLSCH_dci = (void *)UE_info->UE_template[CC_id].DLSCH_DCI[harq_pid];
        ...
        {
          rballoc_sub[i] = UE_info->UE_template[CC_id].rballoc_subband[harq_pid][i];


          if( (subframeP == 0) || (subframeP==5))
          {
              if( (vrb_map[i*3] == 1) ||  (vrb_map[i*3+1] == 1) ||  (vrb_map[i*3+2] == 1))
              {
                rballoc_sub[i] = 0;
                UE_info->UE_template[CC_id].rballoc_subband[harq_pid][i] = 0;
                n_rbg_deleted++;
              }
          }
        ...
        if(0/*(frameP%500)==20 || ((n_rbg_deleted!=0)&&((frameP%1)==0))*/)
        {
          printf("[UE%d] frameP=%d subframeP=%d first_rb=%d nb_rb=%d n_rbg_deleted=%d n_rbg_added=%d dci common:%d ue:%d\n",
              UE_id,frameP, subframeP, first_rb,nb_rb, n_rbg_deleted, n_rbg_added,
        ...
        case 2:
          ...
          if (PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.frame_type == TDD) {
            ...
            case 50:
              ...
              if( subframeP == 0 || subframeP==5)
              {
                printf("error:rballoc=%x nb_rb=%d rballoc_sub=", 
                    ((DCI1_10MHz_FDD_t*)DLSCH_dci)->rballoc, nb_rb);
                for(i=0;i<17;i++)
                {
                    printf("%d ",rballoc_sub[i]);
                }
                printf("\n");
              }*/
...
//------------------------------------------------------------------------------
{
  ...
  for (CC_id=0; CC_id<MAX_NUM_CCs; CC_id++) {
    ...
    BCCH_alloc_pdu=(void*)&eNB->common_channels[CC_id].BCCH_alloc_pdu;
    // clear vrb_map
    memset(vrb_map[CC_id],0,N_RBG_MAX);
    ...
    if (eNB->common_channels[CC_id].bcch_active == 1 && subframeP == 5) {
      ...
      */
      ...
      vrb_map[CC_id][first_rb/min_rb_unit] = 1;
      vrb_map[CC_id][(first_rb+3)/min_rb_unit] = 1;
      ...
      for (i=0; i<NB_RA_PROC_MAX; i++) {
        ...
        if (RA_template->generate_rar == 1) {
          ...
          while (0) {
            ...
            //if ((vrb_map[CC_id][first_rb] != 1) && (vrb_map[CC_id][first_rb+3] != 1))
              break;
          }
        ...
        if (RA_template->generate_Msg4_dci == 1) 
        {
          ...
          if (PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.frame_type == TDD) {
            ...
            case 50:
              ...
              ((DCI1A_10MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->vrb_type=0;
              ((DCI1A_10MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->rv=0;
              ((DCI1A_10MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->ndi=0;
              ((DCI1A_10MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->harq_pid=0;
              ((DCI1A_10MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->TPC=1;
              ((DCI1A_10MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->padding=0;
              ((DCI1A_10MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->rballoc= mac_xface->computeRIV(PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.N_RB_DL,first_rb,4);
            ...
            case 100:
              ...
              ((DCI1A_20MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->vrb_type=0;
              ((DCI1A_20MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->rv=0;
              ((DCI1A_20MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->ndi=0;
              ((DCI1A_20MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->harq_pid=0;
              ((DCI1A_20MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->TPC=1;
              ((DCI1A_20MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->padding=0;
              ((DCI1A_20MHz_FDD_t*)&RA_template->RA_alloc_pdu2[0])->rballoc= mac_xface->computeRIV(PHY_vars_eNB_g[module_idP][CC_id]->lte_frame_parms.N_RB_DL,first_rb,4);
...
//------------------------------------------------------------------------------
{
  ...
  if (UE_id != -1) {
    ...
    return((unsigned char *)&eNB->UE_info[UE_id].DLSCH_pdu[CC_id][TBindex].payload[0]);
  } else {
...
//------------------------------------------------------------------------------
{
  ...
  DCI_PDU             *DCI_pdu   = &eNB_mac_inst[module_idP].common_channels[CC_id].DCI_pdu[subframeP];
  int                  i;
...
//------------------------------------------------------------------------------
{
  ...
  DCI_PDU             *DCI_pdu   = &eNB_mac_inst[module_idP].common_channels[CC_id].DCI_pdu[subframeP];
  int                  i;
  DCI0_10MHz_TDD_1_6_t *ULSCH_dci = NULL;;

  if (mac_xface->lte_frame_parms->frame_type == TDD) {
    for (i=0; i<DCI_pdu->Num_common_dci+DCI_pdu->Num_ue_spec_dci; i++) {
      ULSCH_dci = (DCI0_10MHz_TDD_1_6_t *)DCI_pdu->dci_alloc[i].dci_pdu;

      if ((DCI_pdu->dci_alloc[i].format == format0) && (DCI_pdu->dci_alloc[i].rnti == rnti)) {
        ULSCH_dci->dai = (dai-1)&3;
        //printf("update_ul_dci50:rnti=%x ULSCH_dci->dai=%d\n",rnti,ULSCH_dci->dai);
      }
    }
  }
...
//------------------------------------------------------------------------------
{
  ...
  DCI_PDU             *DCI_pdu   = &eNB_mac_inst[module_idP].common_channels[CC_id].DCI_pdu[subframeP];
  int                  i;
  DCI0_20MHz_TDD_1_6_t *ULSCH_dci = NULL;;

  if (mac_xface->lte_frame_parms->frame_type == TDD) {
    for (i=0; i<DCI_pdu->Num_common_dci+DCI_pdu->Num_ue_spec_dci; i++) {
      ULSCH_dci = (DCI0_20MHz_TDD_1_6_t *)DCI_pdu->dci_alloc[i].dci_pdu;
...
//------------------------------------------------------------------------------
{
  ...
  case 0:
    if ((subframeP==0)||(subframeP==1)||(subframeP==3)||(subframeP==5)||(subframeP==6)||(subframeP==8)) {
      UE_info->UE_template[CC_id].DAI = 0;
    }
