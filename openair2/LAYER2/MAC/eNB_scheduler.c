...
void eNB_dlsch_ulsch_scheduler(module_id_t module_idP,uint8_t cooperation_flag, frame_t frameP, sub_frame_t subframeP)  //, int calibration_flag) {
{
  ...
  for (CC_id=0; CC_id<MAX_NUM_CCs; CC_id++) {
    DCI_pdu[CC_id] = &eNB_mac_inst[module_idP].common_channels[CC_id].DCI_pdu[subframeP];
    nCCE[CC_id]=0;
    nprb[CC_id]=0;
    RBalloc[CC_id]=0;
  ...
  setup_ue_list(module_idP,frameP, subframeP);
  ...
  while (i>=0) {
    ...
    if (mac_xface->get_eNB_UE_stats(module_idP, CC_id, rnti)==NULL) {
      printf("eNB_dlsch_ulsch_scheduler: remove inactive ue%d rnti=%x module_idP=%d CC_id=%d \n",i,rnti,module_idP, CC_id);
  ...
  */
  ...
  case 0:
    ...
    {  
        //FDD
        fill_DLSCH_dci_common(module_idP,frameP,subframeP,RBalloc,1,mbsfn_status,vrb_map);

        schedule_ue_spec_si_ri(module_idP,frameP,subframeP,nprb,nCCE,mbsfn_status,vrb_map);

        fill_DLSCH_dci_ue(module_idP,frameP,subframeP,RBalloc,1,mbsfn_status);
  ...
  case 1:
    ...
    { 
      ...
      schedule_ue_spec(module_idP,frameP,subframeP,nprb,nCCE,mbsfn_status);
      fill_DLSCH_dci(module_idP,frameP,subframeP,RBalloc,0,mbsfn_status);
      schedule_ulsch(module_idP,frameP,cooperation_flag,subframeP,5,nCCE);
    }
  ...
  case 2:
    ...
    if (mac_xface->lte_frame_parms->frame_type == FDD) {  //FDD
      schedule_ue_spec(module_idP,frameP,subframeP,nprb,nCCE,mbsfn_status);
      fill_DLSCH_dci(module_idP,frameP,subframeP,RBalloc,0,mbsfn_status);
      schedule_ulsch(module_idP,frameP,cooperation_flag,subframeP,6,nCCE);
    }
  ...
  case 5:
    ...
    if (mac_xface->lte_frame_parms->frame_type == FDD) 
    {
      schedule_RA(module_idP,frameP,subframeP,7/*1*/,nprb,nCCE);
      ...
      schedule_ulsch(module_idP,frameP,cooperation_flag,subframeP,9,nCCE);
  ...
  case 6:
    ...
    { 
        ...
        schedule_ue_spec(module_idP,frameP,subframeP,nprb,nCCE,mbsfn_status);
        fill_DLSCH_dci(module_idP,frameP,subframeP,RBalloc,0,mbsfn_status);
        schedule_ulsch(module_idP,frameP,cooperation_flag,subframeP,0,nCCE);
    }
  ...
  case 7:
    ...
    { 
      ...
      schedule_ue_spec(module_idP,frameP,subframeP,nprb,nCCE,mbsfn_status);
      fill_DLSCH_dci(module_idP,frameP,subframeP,RBalloc,0,mbsfn_status);
      schedule_ulsch(module_idP,frameP,cooperation_flag,subframeP,1,nCCE);
    }
