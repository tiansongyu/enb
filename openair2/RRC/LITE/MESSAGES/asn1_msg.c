                ...
                )
{
  ...
  *sib3 = &sib3_part->choice.sib3;
  ...
  printf("POWER: do_SIB23:pusch_p0_Nominal=%d pucch_p0_Nominal=%d pusch_alpha=%d pdsch_referenceSignalPower=%d\n",
  ...
  // PDSCH-Config
  //xhd_oai_debug
  (*sib2)->radioResourceConfigCommon.pdsch_ConfigCommon.referenceSignalPower=-65; //0;  // corresponds to 24.7 dBm 5 MHz/ 27.7 10 MHz/ 30.7 20 MHz
  ...
  *physicalConfigDedicated = physicalConfigDedicated2;
  ...
  if (frame_parms->frame_type == FDD) {
    ...
    *(physicalConfigDedicated2->pucch_ConfigDedicated->tdd_AckNackFeedbackMode) =
      PUCCH_ConfigDedicated__tdd_AckNackFeedbackMode_multiplexing;//PUCCH_ConfigDedicated__tdd_AckNackFeedbackMode_bundling;//PUCCH_ConfigDedicated__tdd_AckNackFeedbackMode_multiplexing;
  }
  ...
  physicalConfigDedicated2->uplinkPowerControlDedicated->deltaMCS_Enabled= 0; //UplinkPowerControlDedicated__deltaMCS_Enabled_en1;
...
# endif
  ...
  //#ifdef USER_MODE
  LOG_D(RRC,"RRCConnectionReconfiguration Encoded %d bits (%d bytes)\n",enc_rval.encoded,(enc_rval.encoded+7)/8);
  // for (i=0;i<30;i++)
  //    msg("%x.",buffer[i]);
  // msg("\n");
