...
//-----------------------------------------------------------------------------
{
  ...
  if (ctxt_pP->enb_flag == ENB_FLAG_YES) {
    LOG_I(RRC, PROTOCOL_RRC_CTXT_FMT" OPENAIR RRC IN ENB....\n",
    ...
    NB_eNB_INST = 1;
    LOG_I(RRC, PROTOCOL_RRC_CTXT_FMT" OPENAIR RRC IN UE....NB_eNB_INST=%d\n",
          PROTOCOL_RRC_CTXT_ARGS(ctxt_pP), NB_eNB_INST);

    for (i = 0; i < NB_eNB_INST; i++) {
      LOG_I(RRC, PROTOCOL_RRC_CTXT_FMT" Activating CCCH (eNB %d)\n",
