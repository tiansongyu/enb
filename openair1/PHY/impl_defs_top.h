...
#if defined(CBMIMO1) || defined(EXMIMO) || defined(OAI_USRP)|| defined(ETHERNET)
#define MAX_FRAME_NUMBER 0x400
#define NUMBER_OF_eNB_MAX 1
//xhd_oai_xhd_multuser
//#define NUMBER_OF_UE_MAX 4
#define NUMBER_OF_UE_MAX 64 //16 20users
#define RNTI2UEID(rnti) ((rnti==NOT_A_RNTI)?(-1):((rnti>>8)&0x3f))
#define UEID2RNTI(ueid) ((ueid<<8)|(taus()&0xff))
...
typedef struct {
  ...
  int32_t n0_subband_power_tot_PUCCH[100];
  short n0_subband_power_tot_dB_PUCCH[100];
