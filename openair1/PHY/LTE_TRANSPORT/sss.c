...
int rx_sss(PHY_VARS_UE *phy_vars_ue,int32_t *tot_metric,uint8_t *flip_max,uint8_t *phase_max)
{
  ...
  *tot_metric = -99999999;
  ...
  if (phy_vars_ue->lte_frame_parms.frame_type == FDD) 
  {
      printf("rx_sss:FDD Nid_cell=%d Nid1=%d Nid2=%d\n",phy_vars_ue->lte_frame_parms.Nid_cell,Nid1t,Nid2);
  }
  else
  {
      printf("rx_sss:TDD Nid_cell=%d Nid1=%d Nid2=%d\n",phy_vars_ue->lte_frame_parms.Nid_cell,Nid1t,Nid2);
  }
