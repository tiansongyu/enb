                     ...
                     LTE_eNB_DLSCH_t *dlsch1)
{
  ...
  uint8_t nsymb;
  uint8_t harq_pid = dlsch0->current_harq_pid[subframe_offset];
  ...
  for (l=num_pdcch_symbols; l<nsymb; l++) {
    ...
    for (rb=0; rb<frame_parms->N_RB_DL; rb++) {
      ...
      { 
        ...
        // PBCH  RB=10,11,12,13,14 SYMBOL=7,8,9,10
        ...
        //PBCH subframe 0,  RB=9, SYMBOL=7,8,9,10
        if ((subframe_offset==0) &&
            (rb==((frame_parms->N_RB_DL>>1)-3)) &&
            (l>=(nsymb>>1)) &&
            (l<((nsymb>>1) + 4)))
        ...
        else 
        {
          ...
          //SSS FDD
          if (((subframe_offset==0)||(subframe_offset==5)) && (rb>((frame_parms->N_RB_DL>>1)-3)) 
                && (rb<((frame_parms->N_RB_DL>>1)+3)) && (l==((nsymb>>1)-2)) ) {
            rb_alloc_ind = 0;
          }
      ...
      { 
        // EVEN N_RB_DL
        //PBCH SUBFRAME=0  RB=22,23,24,25,26,27  SYMBOL=7,8,9,10
        if ((subframe_offset==0) &&
            (rb>=((frame_parms->N_RB_DL>>1)-3)) &&
            (rb<((frame_parms->N_RB_DL>>1)+3)) &&
        ...
        { 
          // FDD
          //SSS SUBFRAME=0,5 RB=22,23,24,25,26,27 SYMBOL=5
          if (((subframe_offset==0)||(subframe_offset==5)) 
          ...
          //PSS SUBFRAME=0,5 RB=22,23,24,25,26,27 SYMBOL=6
          if (((subframe_offset==0)||(subframe_offset==5)) 
            && (rb>=((frame_parms->N_RB_DL>>1)-3)) && (rb<((frame_parms->N_RB_DL>>1)+3)) 
            && (l==((nsymb>>1)-1)) ) 
          {
