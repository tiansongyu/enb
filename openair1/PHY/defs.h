...
typedef struct PHY_VARS_eNB_s {
  ...
  LTE_eNB_PUSCH       *lte_eNB_pusch_vars[NUMBER_OF_UE_MAX][10];  //xhd_oai_60m 
  ...
  //xhd_oai_20users
  //int first_run[NUMBER_OF_UE_MAX];
  int max_pos_fil2[NUMBER_OF_UE_MAX];
...
typedef struct {
  ...
  //xhd_oai_ue
  /// \brief Mutex for TX processing thread
  pthread_mutex_t mutex_tx_cnt;
  /// \brief Mutex for RX processing thread
  pthread_mutex_t mutex_rx_cnt;
  ...
  int              rx_offset_diff; /// Timing offset
...
typedef enum
{ 
    PERF_ENB_THREAD_READ,
    PERF_ENB_THREAD_READ_NULL,
    PERF_ENB_THREAD_WRITE,
    PERF_ENB_THREAD_WAKEUP_RX0,
    PERF_ENB_THREAD_WAKEUP_RX,
    PERF_ENB_THREAD_WAKEUP_TX,
    PERF_ENB_THREAD_RX,
    PERF_ENB_THREAD_TX,
    PERF_ENB_THREAD_TX_PROC,
    PERF_ENB_THREAD_TX_DFT_512,
    PERF_ENB_THREAD_TX_DFT_2048,
    PERF_ENB_THREAD_TX_IDFT_512,
    PERF_ENB_THREAD_TX_IDFT_2048,
    PERF_ENB_THREAD_RX_OFDM_DECODE_25,
    PERF_ENB_THREAD_TX_OFDM_DECODE_100,
    PERF_ENB_THREAD_TX_OFDM_ENCODE_25,
    PERF_ENB_THREAD_TX_OFDM_ENCODE_100,
    PERF_UE_THREAD_SYNC,
    PERF_UE_THREAD_WAKEUP_RX,
    PERF_UE_THREAD_WAKEUP_TX,
    PERF_UE_THREAD_TX_OFDM_ENCODE_25,
    PERF_UE_INITIAL_SYNC,
    PERF_UE_INITIAL_SYNC0,
    PERF_UE_INITIAL_SYNC1,
    PERF_UE_SYNC_TIME,
    PERF_UE_THREAD_RX,
    PERF_UE_phy_procedures_UE_RX,
    PERF_UE_rx_phich,
    PERF_UE_generate_ue_ulsch_params_from_dci,
    PERF_UE_dci_decoding_procedure,
    PERF_UE_ue_scheduler,
    PERF_UE_THREAD_TX,
    PERF_UE_phy_procedures_UE_TX,
    PERF_UE_UE_thread,
    PERF_MAX_ITEM_NUM
}enum_perf;

#define PERF_START 0
#define PERF_FINISH 1
#define PERF_PERIOD 2
#define PERF_PERIOD_WAIT 3
#define PERF_ONCE 4
#define PERF_LINE 5

#define PERF_TIME(a, flag) {TIME_##flag(a, #a );}
#define PERF_TIME_LINE(a, flag) {TIME_##flag(a, #a, __LINE__ );}
#define PERF_TIME_COND(cond, a, b, flag) {if(cond)TIME_##flag(a, #a );else TIME_##flag(b, #b );}


#define TP_RECORD(tp) {\
        if(tp.count<20){\
        struct timespec cu_time;\
        clock_gettime(CLOCK_MONOTONIC, &cu_time);\
        tp.line[tp.count]=__LINE__;\
        tp.time[tp.count]=cu_time.tv_nsec/1000; \
        tp.count++;}}
