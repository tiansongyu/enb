...
echo "######### Start UE ETHERNET ###########" 
ulimit -c unlimited
sudo rm -r core
./oai.ue.eth -U -C 3580000000 -r 25 --ue-txgain 101 --ue-rxgain  110 --ue-scan-carrier --ue-amp 200 -O ../conf/enb-f25b3.conf -N ../conf/enb.base.band3.conf 
